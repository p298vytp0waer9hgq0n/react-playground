import image from '../../images/wedding.png';
...
export default function Card () {
    ...
    return (
        <div className="air-card">
            ...
            <img className="air-card__img" src={image} alt="bride" />
            <div className="air-card__rating">
              ...
              &nbsp;5.0 <span className="air-card__lighter">(6) &middot; USA</span>
            </div>
            <p>Learn wedding photography</p>
            <p><span className="air-card__darker">From $136</span> / person</p>
            <p>Good {timeOfDay}!</p>
        </div>
    )
}